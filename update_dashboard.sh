...
for script in purge_history.py personas_tracking.py detect_narratives.py detect_coordination.py agenda_setting.py build_network.py propagation_analysis.py; do
    echo "[$timestamp] → Ejecutando $script ..." >> "$LOG_FILE"
